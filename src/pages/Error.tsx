...
export default function ErrorPage() {
  ...
  useDocumentHead({
    title: `اداء - ${error.statusText || 'خطأ'}`,
    description: error.data,
    ogTitle: `اداء - ${error.statusText || 'خطأ'}`,
    ogDescription: error.data
  });

  return (
    <div id="error-page" className="container flex h-screen flex-col items-center justify-center gap-4">
